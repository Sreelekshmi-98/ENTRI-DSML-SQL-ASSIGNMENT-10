...
CREATE TABLE teachers (Id INT PRIMARY KEY, Name VARCHAR(140), Subject VARCHAR(150),
    Experience INT, Salary DECIMAL(10, 2)
);
...
CREATE TABLE Teacher_log (Teacher_id INT, action VARCHAR(80),action_timestamp TIMESTAMP);
